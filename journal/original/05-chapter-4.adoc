...
but a fear of not feeling sufficient authority:--'`seekest thou great things?`'
...
"`10th. Left Amsterdam with John Vanderwerf Jr., and Frederick Mentz, in a carriage boat,
...
// lint-disable invalid-characters
and left it again the 2nd of the seventh month, travelling post to Alençon;
...
went on second-day afternoon from thence to Gloucester.
